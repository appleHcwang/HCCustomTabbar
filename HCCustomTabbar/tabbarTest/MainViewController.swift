...
class MainViewController: UITabBarController {
    ...
    func createTabbar(){
        ...
        let four = UINavigationController(rootViewController: threeViewController(nibName: nil, bundle: nil))
        
        let item4:UITabBarItem = UITabBarItem(title: "第四", image: UIImage(named: "tab3_default"), selectedImage: UIImage(named: "tab3_selected"))
        ...
        //吧这3个导航控制器 加入数组
        let tabArry = [first,second,three,four];
        //加入tabbar控制器
